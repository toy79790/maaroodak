# DEPLOYMENT — نشر «معروضي» على منصة مُدارة (Vercel + Neon)

> ⚠️ **ليس المسار المعتمد.** الإنتاج على Oracle Cloud جدة (#D-033) —
> الدليل المعتمد: [deploy/README.md](../deploy/README.md). تبقى هذه الوثيقة
> مرجعاً إن تغيّر القرار لاحقاً.

...
/**
 * مدة حجز المقابلة أثناء توليدها — #D-045
 *
 * بعدها يُعدّ الحجز مهجوراً (عملية ماتت في منتصف التوليد) ويُسمح بحجزها من
 * جديد. أطول من أسوأ توليد ممكن: مهلة 90 ثانية × إعادتا محاولة في الـ SDK
 * × إعادة توليد عند مخالفة ضوابط، ثم فحص الجودة.
 */
export const GENERATION_LOCK_STALE_MS = 10 * 60_000;
